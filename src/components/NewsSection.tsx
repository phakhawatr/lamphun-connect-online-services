...
const NewsItem = ({ title, date, image, url, isFirst = false }: NewsItemProps) => {
  return (
    <Card className="overflow-hidden border-0 shadow-md h-full">
      ...
      <CardFooter className="pb-4 pt-0">
        {isFirst ? (
          <Button variant="outline" asChild className="border-lamphun-primary text-lamphun-primary hover:bg-lamphun-primary hover:text-white">
  ...
  return (
    <section className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12 underline-heading">ข่าวสาร</h2>
